...
\todo[inline]{Be explicit is stating that the lookup is based on the length of the input, while with hashes the length is constant}
...
\todo[inline]{Add example on how the incremental computation is used}
