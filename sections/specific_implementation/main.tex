...
\todo[inline]{Looking up a value in a trie takes time proportional to the size of the value.}
\todo[inline]{Explain HashMap and that it uses Tries, which leads to constant lookups}
