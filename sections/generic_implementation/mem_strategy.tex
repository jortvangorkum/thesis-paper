...
\todo[inline]{Add implementation for the usage of cache addition policy (in cataMerkleState)}
...
\todo[inline]{Go from intermediate values to cached results}
...
\todo[inline]{Show implementation of cataMerkle}
\begin{minted}{haskell}
