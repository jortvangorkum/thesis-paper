...
\end{enumerate*}
The implementation of the general zipper is based on the paper \citetitle{bransen2015incremental} by \citeauthor{bransen2015incremental}\cite{bransen2015incremental}.
