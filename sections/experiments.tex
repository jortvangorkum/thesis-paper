...
\question{Should I add this?}
\todo[inline]{Add command used for profiling memory usage}
...
\subsubsection{Minimum of 5 recursive calls}
\begin{figure}[H]
  \begin{minipage}{.5\textwidth}
    \centering
...
\subsubsection{Minimum of 10 recursive calls}
\begin{figure}[H]
  \begin{minipage}{.5\textwidth}
    \centering
